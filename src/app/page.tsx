...
export default function DashboardPage() {
  ...
  /* Stats par type — bénéfice inclut manual_profit */
  ...
  const sumProfit = (arr: Quote[]) => arr.reduce((s, q) => s + effectiveProfit(q), 0)
        ...
        <div style={{ padding:'1rem 1.25rem', borderRadius:'1rem', display:'flex', alignItems:'center', gap:'1rem', ...S }}>
          ...
          <div>
            ...
            <div style={{ fontSize:'0.75rem', color:'var(--color-text-muted)', marginTop:2 }}>
              Bénéfice net total (manuel inclus)
            </div>
          </div>
        </div>
      </div>
